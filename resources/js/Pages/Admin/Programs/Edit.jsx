...
export default function ProgramsEdit({ program }) {
    ...
    const existingImage = program.image_path
            ...
            header={
                <div className="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <h2 className="mt-2 text-2xl font-bold text-[#111827]">Edit Program Latihan</h2>
                        <p className="mt-1 text-sm text-[#111827]/60 line-clamp-1">{program.title}</p>
                    </div>
                    <Link href={route('admin.programs.index')} className="tarung-button-secondary shrink-0">
                        ← Kembali
                    </Link>
                </div>
            }
        >
            <Head title="Edit Program Latihan" />
                ...
                <div className="tarung-shell rounded-[28px] p-6 sm:p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-[#111827] mb-1.5">Estimasi Durasi</label>
                                <input
                                    type="text"
                                    value={data.duration}
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-[#111827] mb-1.5">
                                ...
                                {existingImage && !preview && (
                                    <span className="ml-2 font-normal text-[#111827]/50">(biarkan kosong untuk tetap pakai foto lama)</span>
                                )}
                            </label>
                            <input
                                type="file"
                                ...
                                className="hidden"
                                id="program-image-edit"
                            />
                            <label
                                htmlFor="program-image-edit"
                            ...
                            >
                                {(preview || existingImage) ? (
                                    ...
                                    <div className="text-center px-4">
                                        ...
                                        <p className="text-sm text-[#111827]/60">Klik untuk memilih foto baru</p>
