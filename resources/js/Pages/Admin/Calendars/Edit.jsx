...
export default function CalendarsEdit({ calendar, eventTypes = [] }) {
    const startDateTime = new Date(calendar.start_date);
    const endDateTime = new Date(calendar.end_date);
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        patch(route('admin.calendars.update', calendar.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <div>
                    ...
                    <h2 className="mt-2 text-2xl font-bold text-[#111827]">Edit Jadwal</h2>
                </div>
            }
        >
